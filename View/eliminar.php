                     ...
                     <div class="col-md-12">
                         <div class="col-md-8 mx-auto">
                             <div class="form-group">
                                 <br>
                                 <form id="form2" name="form2" method="post" action="eliminar.php" class="form-group">
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <?php
                                                    ...
                                                    $contraseña = "";
                                                    ?>
                                                 <input type="number" name="Buscar" id="Buscar" class="form-control form-control-user mb-2 mr-5" size="40" value="<?php echo $co; ?>" required />
                                             </td>
                                             <?php
                                 ...
                                 <form id="form1" name="form1" method="post" action="../Controller/ValidarEliminarUsuario.php">
                                     <td> <input class="btn btn-danger mt-3" type="submit" name="button" id="button" value="ELIMINAR">
                                     </td>
                                     <td colspan="2" align="center"> Identificación a Eliminar
                                         <input type="number" name="co" id="co" readonly="readonly" size="40" value="<?php echo $co; ?>" class="form-control form-control-user " required />
                                     </td>
                                     </tr>
                                     </table>
                                 </form>
