            ...
            <div class="card-body p-3 bg-gray-300">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3" style="text-align: center;">
                        <h2 class="m-0 font-weight-bold text">Administrar concepto business partner</h2>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="10">
                                ...
                                while ($datos = $rta->fetch_array()) {
                                    $info = $datos['nombreCandidato'] . "||" . $datos['idBP'];
                                    $i = $datos['nombreCandidato'] . "||" . $datos['idBP'];
                                ?>
                                    <style>
                                        i {
                                            margin-top: 3px;
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a href="" onclick="agregarModal5('<?php echo $info ?>')" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-trash-alt" title="Solicitar eliminacion de entrevista" style="color: red; width: 50px; font-size: 2rem;"></i></a>
                                                <a href="" onclick="agregarModal6('<?php echo $i ?>')" id="correo" data-toggle='modal' data-target='#exampleModal2'><i class='fas fa-envelope-open-text correo' style='color: blue; width: 50px; font-size: 2rem;'></i></a>
                                                <?php
                                                $cc = $datos['idBP'];
                                                if ($datos['modificar'] == 'True') {
                                                    echo "<a href='editarEntrevistaBP.php?cc=$cc'><i class='fas fa-edit' title='Editar entrevista' style='color: green; width: 50px; font-size: 2rem;'></i></a>";
                                                }
                                                ?>
                                            </td>
                                        </tr>
            ...
            <div class='modal-dialog' role='document'>
                <div class='modal-content'>
                    ...
                    <div class='modal-footer'>
                        ...
                        <a><button id="btn" onclick="solicitarEliminacionBP()" class='btn btn-success'>Enviar</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class='modal fade' id='exampleModal2' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
            <div class='modal-dialog' role='document'>
                <div class='modal-content'>
                    ...
                    <div class='modal-footer'>
                        <button type='button' class='btn btn-danger' data-dismiss='modal'>Cerrar</button>
                        <a><button id="boton" onclick="solictarEdicionBP()" class='btn btn-success'>Enviar</button></a>
                    </div>
                </div>
            </div>
        </div>
