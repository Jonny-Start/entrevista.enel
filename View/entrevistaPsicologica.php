...
<div class="container">
    ...
    <a href="consultarEntrevistaPsicologa.php" class="text-right">Administrar</a> 
    <div class="progress">
                ...
                <div class="row row-cols-3">
                    ...
                    <div class="col pr-5">
                        ...
                        <div class="col ml-2 pb-2">
                            <input type="checkbox" class="form-check-input" id="office_basics" value="si" name="office_basics" required>
                        ...
                        <div class="col ml-2 pr-5 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="office_advanced" name="office_advanced" required>
                        ...
                        <div class="col ml-2 pr-4 pb-2">
                            <input type="checkbox" class="form-check-input" id="communication_tools" value="si" name="communication_tools" required>
                            <label class="form-check-label" for="defaultCheck1"> Communication tools (Teams, Yammer)</label>
                        </div>
                        <div class="col ml-2 pb-2">
                            <input type="checkbox" class="form-check-input" id="project_management" value="si" name="project_management" required>
                        ...
                        <div class="col ml-2 pb-2">
                            <input type="checkbox" class="form-check-input" id="desing_thinking" value="si" name="desing_thinking" required>
                    ...
                    <div class="col">
                        ...
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="knowledge_networking" name="knowledge_networking" required>
                            <label class="form-check-label" for="defaultCheck1">
                                Knowledge Networking
                            </label>
                        </div>
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="problem_solving" name="problem_solving" required>
                            <label class="form-check-label" for="defaultCheck1">
                                Problem Solving
                            </label>
                        </div>
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="virtual_communication" name="virtual_communication" required>
                            <label class="form-check-label" for="defaultCheck1">
                                Virtual Communication
                            </label>
                        </div>
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="digital_awareness" name="digital_awareness" required>
                            <label class="form-check-label" for="defaultCheck1">
                                Digital Awareness
                            </label>
                        </div>
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="data_and_device_security" name="data_and_device_security" required>
                            <label class="form-check-label" for="defaultCheck1">
                                Data and device security
                            </label>
                        </div>
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="content_creation" name="content_creation" required>
                            <label class="form-check-label" for="defaultCheck1">
                                Content creation
                            </label>
                        </div>
                    ...
                    <div class="col">
                        ...
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="programming" name="programming" required>
                            <label class="form-check-label" for="defaultCheck1">
                        ...
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="cyber_security" name="cyber_security" required>
                            <label class="form-check-label" for="defaultCheck1">
                                Cyber Security
                            </label>
                        </div>
                        <div class="col ml-2 pb-2">
                            <input class="form-check-input" type="checkbox" value="si" id="ux/ui_desing" name="ux/ui_desing" required>
                            <label class="form-check-label" for="defaultCheck1">
                                UX/UI Desing
                            </label>
                        </div>
