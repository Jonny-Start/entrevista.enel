            ...
            <div class="card-body p-3 bg-gray-300">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3" style="text-align: center;">
                        <h2 class="m-0 font-weight-bold text">Todas las entrevistas Tecnicas</h2>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" width="100%" cellspacing="10">
                                ...
                                $sql = "SELECT * FROM `entrevistatecnica` where terminada = 'True' ";
                                ...
                                ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="../Reportes/pdf-EntrevistaTecnica.php?cc=<?php echo $datos['idTec'] ?>" target="_blank"><img src="../img/pdf.png" alt="Sacar Reporte" width="30" height="40" style="padding: 0px;"></a></td>
                                        </tr>
