...
<form class="user" method="post" action="../Controller/validarco.php">
    ...
    <div class="form-row" style="padding: 10px;">
        <div class="col-md-3" id="dato">
            <input id="co" name="co" type="number" placeholder="no es un numero lo que ingresaste" value="" class="form-control">
        <br>
        </div><br>
...
<script src="../js/validarCo.js"></script>
</body>
