      ...
      <div class="card-body p-3 bg-gray-300">
              ...
              <div class="form-group">
                ...
                <div class="card shadow mb-4">
                  <div class="card-header py-3" style="text-align: center;">
                    <h2 class="m-0 font-weight-bold text">Administrar Entrevista Tecnica (Eliminar)</h2>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered" width="100%" cellspacing="10">
                        ...
                        $sql = "SELECT entrevistatecnica.nombreCandidato, entrevistatecnica.idTec, entrevistatecnica.proceso, entrevistatecnica.fechaEntrevista, entrevistatecnica.cargoAspira, usuario.correo_electronico FROM usuario , entrevistatecnica where terminada = 'True' and modificar = 'Eliminar' and usuario.co = entrevistatecnica.co ";
                        $rta = $objCnx->query($sql);
                        while ($datos = $rta->fetch_array()) {
                          $info = $datos['nombreCandidato'] . "||" . $datos['idTec'] . "||" . $datos['correo_electronico'];
                        ?>
                          <style>
                            i {
                              margin-top: 3px;
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td style="text-align: center;">
                                ...
                                <a href="../Controller/ControllerNegarEliminacionTecnica.php?cc=<?php echo $datos['idTec'] ?>&&ps=<?php echo $datos['correo_electronico'] ?>&&persona=<?php echo $datos['nombreCandidato'] ?>"><i class='fas fa-ban' title="Negar" style='color: green; width: 50px; font-size: 2rem;'></i></a>
                              </td>
                            </tr>
                          <?php
                        }
        ...
        <script type="text/javascript">
          ...
          function EliminacionTecnica() {
            ...
            $.ajax({
              type: "POST",
              url: "../Controller/ValidarEliminarEntrevistaTecnica.php?",
              data: cadena,
              success: function(r) {
                if (r == 1) {
          ...
          <div class='modal-dialog' role='document'>
            <div class='modal-content'>
              ...
              <div class='modal-footer'>
                ...
                <a><button id="btn" onclick="EliminacionTecnica()" class='btn btn-success'>Enviar</button></a>
              </div>
            </div>
          </div>
        </div>
