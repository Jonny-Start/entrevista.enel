...
$sql = "UPDATE entrevistatecnica set modificar= 'Solicitado' where idTec='$cc'";
          ...
          <table cellpadding='0' cellspacing='0' width='600' class='w320'>
            <tr>
              <td align='left' class='mobile-padding' style='padding:20px 20px 30px'>
                ...
                ¡Hola!
                <br><br>
                El Jefe... acaba de solicitar la edicion del concepto de la persona con nombre $nombre y su cedula es $cc;
                <br>
                <br><br>
