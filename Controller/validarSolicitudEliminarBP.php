...
$sql = "UPDATE entrevistabp set modificar= 'Eliminar' where idBP='$cc'";
          ...
          <table cellpadding='0' cellspacing='0' width='600' class='w320'>
            <tr>
              <td align='left' class='mobile-padding' style='padding:20px 20px 30px'>
                ...
                ¡Hola!
                <br><br>
                El Business Partner... acaba de solicitar la eliminacion del concepto de $nombre con cedula $cc;
                <br>
                <br><br>
