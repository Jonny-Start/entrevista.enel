            ...
            <table cellpadding='0' cellspacing='0' width='600' class='w320'>
              <tr>
                <td align='left' class='mobile-padding' style='padding:20px 20px 30px'>
                  ...
                  ¡Hola!
                  <br><br>
                  La Psicologa ... acaba de solicitar la eliminacion de esta persona con nombre $nombre y su cedula es $cc;
                  <br>
                  <br><br>
                    ...
                    <tr>
                      <td align='right' width='220' style='padding-right:20px; vertical-align:middle;'>
                        <table width='94' align='right' cellpadding='0' cellspacing='0'>
                          <tr>
                            <td>
                              <img src='https://image.flaticon.com/icons/png/512/51/51418.png' style='display:block' width='220' height='294' alt='profile'/>
                            </td>
                          </tr>
                        </table>
                      </td>
