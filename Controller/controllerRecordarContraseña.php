          ...
          <table cellpadding='0' cellspacing='0' width='600' class='w320'>
            <tr>
              <td align='left' class='mobile-padding' style='padding:20px 20px 30px'>
                ...
                ¡Hola!
                <br><br>
                Acabas de informar de que olvidaste tu contraseña, por este motivo borramos tu contraseña actual y te asignamos una diferente, la cual puedes utilizar hasta el momento que lo permitas, sino puedes cambiarla facilmente en tu <a href='http://localhost/proyecto/view/misDatos.php'>Perfil</a>.
                <br>
                <br><br>
