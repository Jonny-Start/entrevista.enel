                  ...
                  <table cellspacing='0' cellpadding='0' width='100%' bgcolor='#ffffff'>
                    <tr>
                      <td style='width:130px;background:#D84A38;'>
                        <div>
                              <a href='http://localhost/proyecto/Reportes/reporteJefe.php?cc=$cc' target='_blank' style='background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;'>Visualizar entrevista</a>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td align='right' width='220' style='padding-right:20px; vertical-align:middle;'>
                        <table width='94' align='right' cellpadding='0' cellspacing='0'>
                          <tr>
                            <td>
                              <img src='https://image.flaticon.com/icons/png/512/51/51372.png' style='display:block' width='300' height='300' alt='profile'/>
                            </td>
                          </tr>
                        </table>
                      </td>
...
try {
    ...
    $mail->addAddress($jefe);  //a quien se le va a enviar    // Add a recipient
    ...
    $mail->Subject = 'Informacion de entrevista '. $nombre;
    $mail->Body    =  $body;
    $mail->CharSet = 'UTF-8';
