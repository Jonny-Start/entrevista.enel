...
$sql = "DELETE FROM entrevistatecnica where idTec = ?";
...
$body = " <style> img {
  ...
  <table align='center' cellpadding='0' cellspacing='0' width='60%' height='100%'>
  <tr>
            ...
            <table cellpadding='0' cellspacing='0' width='600' class='w320'>
              <tr>
                <td align='left' class='mobile-padding' style='padding:20px 20px 30px'>
                  ...
                  <h1>Enel Colombia<br> entrevistas</h1>
  
                  <br>
                  ¡Hola!
                  <br><br>
                  La entrevista de $persona que solicitaste $solicitud ha sido <b>$respuesta</b>. 
                  <br><br>
                  ...
                  <table cellspacing='0' cellpadding='0' width='100%' bgcolor='#ffffff'>
                    <tr>
                      <td style='width:130px;background:#D84A38;'>
                        <div>
                              <a href='http://localhost/proyecto/View/AdministrarEntrevistaPs.php' target='_blank' style='background-color:#D84A38;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:33px;text-align:center;text-decoration:none;width:130px;-webkit-text-size-adjust:none;'>Ir a editar la entrevista</a>
                        </div>
                      </td>
...
try {
    ...
    $mail->addAddress($pscologa);  //a quien se le va a enviar    // Add a recipient
    ...
    $mail->Subject = 'Información de entrevista ';
    $mail->Body    =  $body;
    $mail->CharSet = 'UTF-8';
